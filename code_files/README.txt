This folder contains the code used to simulate the datasets, setup the RevBayes runs, analyze the results and build the figures.

It is divided in the following folders :
