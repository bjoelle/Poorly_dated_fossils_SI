...
- taxa_x_y.tsv contain the modified age ranges with imprecise-date fossils, indexed by the interval used for imprecise-date fossils (x = 1, 2 or 3) and the proportion of imprecise-date fossils (y = 0.5 or 1)
